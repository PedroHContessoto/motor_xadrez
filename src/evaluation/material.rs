...
pub fn analyze_material(board: &Board, game_phase: &GamePhase) -> MaterialAnalysis {
    ...
    let phase_value = match game_phase {
        GamePhase::Opening => 0,
        GamePhase::EarlyMiddlegame => 0,
        GamePhase::Middlegame => 1,
        GamePhase::LateMiddlegame => 1,
        GamePhase::EarlyEndgame => 2,
        GamePhase::Endgame => 2,
        GamePhase::LateEndgame => 2,
        GamePhase::PureEndgame => 2,
        GamePhase::TheoreticalEndgame => 2,
    };
...
fn evaluate_knight_specific(board: &Board, square: u8, color: Color, game_phase: &GamePhase) -> i32 {
    ...
    if super::utils::is_outpost(square, color, enemy_pawns) {
        bonus += match game_phase {
            ...
            GamePhase::LateMiddlegame => 30,
            GamePhase::EarlyEndgame => 35,
            GamePhase::Endgame => 35,
            GamePhase::LateEndgame => 35,
            GamePhase::PureEndgame => 35,
            GamePhase::TheoreticalEndgame => 35,
        };
...
fn evaluate_bishops_enhanced(board: &Board, mut bishop_bb: Bitboard, color: Color, game_phase: &GamePhase) -> i32 {
    ...
    if board.has_bishop_pair(color) {
        score += match game_phase {
            ...
            GamePhase::EarlyMiddlegame => BISHOP_PAIR_BONUS[0],
            GamePhase::Middlegame => BISHOP_PAIR_BONUS[1],
            GamePhase::LateMiddlegame => BISHOP_PAIR_BONUS[1],
            GamePhase::EarlyEndgame => BISHOP_PAIR_BONUS[2],
            GamePhase::Endgame => BISHOP_PAIR_BONUS[2],
            GamePhase::LateEndgame => BISHOP_PAIR_BONUS[2],
            GamePhase::PureEndgame => BISHOP_PAIR_BONUS[2],
            GamePhase::TheoreticalEndgame => BISHOP_PAIR_BONUS[2],
        };
    }
...
fn evaluate_center_control(board: &Board, color: Color, game_phase: &GamePhase) -> i32 {
    ...
    let center_multiplier = match game_phase {
        ...
        GamePhase::LateMiddlegame => 0.8,
        GamePhase::EarlyEndgame => 0.6,
        GamePhase::Endgame => 0.5,
        GamePhase::LateEndgame => 0.4,
        GamePhase::PureEndgame => 0.3,
        GamePhase::TheoreticalEndgame => 0.2,
    };
